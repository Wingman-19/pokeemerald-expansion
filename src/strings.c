...
const u8 gText_Normal_Type[] = _("Normal");
const u8 gText_Fighting_Type[] = _("Fighting");
const u8 gText_Flying_Type[] = _("Flying");
const u8 gText_Poison_Type[] = _("Poison");
const u8 gText_Ground_Type[] = _("Ground");
const u8 gText_Rock_Type[] = _("Rock");
const u8 gText_Bug_Type[] = _("Bug");
const u8 gText_Ghost_Type[] = _("Ghost");
const u8 gText_Steel_Type[] = _("Steel");
const u8 gText_Fire_Type[] = _("Fire");
const u8 gText_Water_Type[] = _("Water");
const u8 gText_Grass_Type[] = _("Grass");
const u8 gText_Electric_Type[] = _("Electric");
const u8 gText_Psychic_Type[] = _("Psychic");
const u8 gText_Ice_Type[] = _("Ice");
const u8 gText_Dragon_Type[] = _("Dragon");
const u8 gText_Dark_Type[] = _("Dark");
const u8 gText_Fairy_Type[] = _("Fairy");
const u8 gText_All_Types[] = _("All");
const u8 gText_No_Types[] = _("None");
